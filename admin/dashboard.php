...
<html>
<head>
<title>ATC Performance Check</title>
...
<body>
	<div class="header">
		<div class="headerKiri"><img src="../images/icon.png" style="width: 100px;"></div>
		<div class="headerKanan">Welcome In<br> ATC Performance Check
			
			<label style="font-size: 12px">ATC Performance Check<label>
	</div>
	</div>
	<div class="wrap">
			...
			Dashboard <?php
				if(isset($_GET['pages'])){
					if ($_GET['pages']=="pengguna") {
						...
						echo " / Cetak Dokumen";
					}else if($_GET['pages']=="Cetak Form ATC") {
						echo " / Cetak Form ATC";
			...
			<ul>
				...
				<li id="btnAdministrasi"><img src="images/folder.png" style="margin-right: 5px;">Administrasi
					<ul class="menuAnakAdministrasi">
						<a href="?pages=jurusan"><li>- Rating</li></a>
						<a href="?pages=kelas"><li>- Unit</li></a>
						<a href="?pages=mapel"><li>- Materi</li></a>
						<a href="?pages=siswa"><li>- Karyawan</li></a>
					</ul>
				</li>
				<?php }?>		
				...
				<a href="?pages=cetakf"><li><img src="images/printer.png" style="margin-right: 5px;">Cetak Form ATC</li></a>
		...
		<?php
			if(isset($_GET['pages'])){
				...
				}else if($_GET['pages']=="cetakf"){
					include 'pages/cetakf.php';
				}else if($_GET['pages']=="bares"){
