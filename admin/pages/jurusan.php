...
<body>
	...
	<div class="box2">
		<b>Data Pengguna / Rating</b>
		<br><br><br>
		<input type="text" class="input" id="search" placeholder="Search">
		&nbsp
		<button class="button" id="btnTambah"><img style="margin-right: 5px;" src="images/plus.png">Tambah Rating</button>
		&nbsp
		<br><br>
	...
	<div class="modalTambah">
		<table border="0" cellspacing="10" width="100%">
			<tr>
				<td><input type="text" id="nama" class="input" placeholder="Nama Rating" style="width: 100%"></td>
			</tr>
