			    ...
			    $("#btnEdit").click(function(){
			    	...
			    	$.ajax({
			            ...
			            success : function(data){            	
			                alert("Perubahan Rating Kelas Telah Berhasil");
	...
	<div class="box2">
		...
		<table class="table">
			...
			<tr>
				...
				<td width="200px">					
					<button class="button" id="btnEdit"><img style="margin-right: 5px;" src="images/pencil.png">Edit Rating</button>
				</td>
			</tr>
		</table>
	</div>
