			    ...
			    $("#btnMulaiTambah").click(function(){
			    	...
			    	$.ajax({
			            ...
			            success : function(data){
			                ...
			                $(".loadon").load("data/data_kelas.php?katakunci="+katakunci);
			                $(".modalTambah").hide();
			                alert("Penambahan Unit Telah Berhasil");
			                $(".bloker").hide();
			            }
			        });
			    });
...
<body>
	...
	<div class="box2">
		<b>Data Pengguna / Unit</b>
		<br><br><br>
		<input type="text" class="input" id="search" placeholder="Search">
		&nbsp
		<button class="button" id="btnTambah"><img style="margin-right: 5px;" src="images/plus.png">Tambah Unit</button>
		&nbsp
		<a href="data/data_kelas_export.php" class="buttonOrange" style="font-size: 13px;"><img style="margin-right: 5px;" src="images/download.png">Download ID Unit</a>
		<br><br>
	...
	<div class="modalTambah">
		<table border="0" cellspacing="10" width="100%">
			<tr>
				<td><input type="text" id="nama" class="input" placeholder="Nama Unit" style="width: 100%"></td>
			</tr>
			<tr>
				<td>
