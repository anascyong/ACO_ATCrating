			    ...
			    $("#btnEdit").click(function(){
			    	...
			    	$.ajax({
			            ...
			            success : function(data){            	
			                alert("Perubahan Data Karyawan Telah Berhasil");
...
<body>
	...
	<div class="box2">
		...
		?>
		<b>Edit Karyawan / Administratif</b>
		<br><br>
		<table class="table">
			<tr>
				<th>Nomor Peserta</th>
			...
			<tr>
				...
				<td width="200px">					
					<button class="button" id="btnEdit"><img style="margin-right: 5px;" src="images/pencil.png">Edit Unit</button>
				</td>
			</tr>
		</table>
	</div>
