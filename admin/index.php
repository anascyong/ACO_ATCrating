	...
	<div class="wrap">
		...
		<div class="kanan">
			<div class="judulKanan">
				<img src="images/icon.png" style="width: 80px;">
				<h3> APLIKASI UJIAN CBT  </h3>
				<h2> UNTUK PENERBITAN / PERPANJANGAN RATING
PERSONEL PEMANDU LALU LINTAS PENERBANGAN </h2>
			</div>
			<div class="isiKanan">
				<form action="login.php" method="POST">
				<table class="boxLogin">
					<tr><td><h2>ATC Performance Check LOGIN</h2></td><tr>
